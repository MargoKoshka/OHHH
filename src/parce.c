...
{
	if (!ft_strcmp(tab[i][0], "Light"))
        init_light(paint, tab, i);
	else if (!ft_strcmp(tab[i][0], "Sphere"))
        init_sphere(paint, tab, i);
	else if (!ft_strcmp(tab[i][0], "Plane"))
		init_plane(paint, tab, i);
	else if (!ft_strcmp(tab[i][0], "Cylind"))
	    init_cylind(paint, tab, i);
	else if (!ft_strcmp(tab[i][0], "Konys"))
